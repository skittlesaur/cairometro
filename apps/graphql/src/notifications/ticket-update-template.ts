...
const mjmlTicketUpdateTemplate = (variables: Variables) => `<mjml>
<mj-body>
<mj-section>
    <mj-column>
    ...
    <mj-text font-size="25px" color="#F45E43" font-family="helvetica">Ticket Update</mj-text>
...
export default mjmlTicketUpdateTemplate