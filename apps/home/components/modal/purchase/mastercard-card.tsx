...
const MastercardCard = ({ validThru, cardHolder, formattedCardNumber }: DefaultCardProps) => {
  return (
    <motion.div
      ...
      className="relative z-[1] bg-gradient-to-br from-[#000000] to-[#0FB8B8] text-white p-8 flex flex-col justify-end w-full md: min-h-40 aspect-video rounded-2xl font-mono"
    >
      <p className="text-sm">
        {validThru || 'MM/YY'}
      </p>
