...
const VisaCard = ({ validThru, cardHolder, formattedCardNumber }: DefaultCardProps) => {
  return (
    <motion.div
      ...
      className="relative z-[1] bg-gradient-to-br from-[#52B6FE] to-[#6154FE] text-white p-8 flex flex-col justify-end w-2/5 min-h-40 aspect-video rounded-2xl font-mono"
    >
      <p className="text-sm">
        {validThru || 'MM/YY'}
      </p>
