const Companion = () => {
    return (
      <div className="h-screen flex items-center justify-center flex flex-col">
        <div className="h-26">
            <strong><h1 className="text-5xl relative text-center">Your Cairo Metro Companion</h1></strong>
            <br></br>
            <p className="text-xl text-[#A3A3A3] align-[80px] leading-3">Enjoy a stress-free commute with convenient metro schedules, payment options, alerts, and assistance.</p>
        </div>
        <br></br>
        <br></br>
        <br></br>
