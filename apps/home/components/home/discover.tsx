...
const Discover = ()=>{
  ...
  return (
    ...
    <div className="w-full flex flex-col items-center gap-4">
      ...
      >
        <div className=" w-[51%]  lg:flex px-16 flex w-full items-center gap-8">
          
          <div className="">
            <p className="text-lg font-medium text-center ">Sadat</p>
          ...
          <div className="">
            <p className="text-lg font-medium text-center ">Maadi</p>
      ...
      <Link
        href="#"
        className="delay 150ms flex items-center bg-white border border-gray-300 rounded-2xl shadow  hover:shadow-lg w-full py-8 px-16 gap-4 justify-between"
      >
        <div className=" w-[51%]  lg:flex px-16 flex w-full items-center gap-8">
          
          <div className="">
            <p className="text-lg font-medium text-center ">Kit-Kat</p>
          ...
          <div className="rounded-full bg-gray-300 min-w-[0.75em] max-w-[0.75em] min-h-[0.75em] max-h-[0.75em]"></div>
          <div className="">
            <p className="text-lg font-medium text-center ">Adly Mansour</p>
      ...
      >
        <div className=" w-[51%]  lg:flex px-16 flex w-full items-center gap-8">
          ...
          <div className="">
            <p className="text-lg font-medium text-center ">Safaa Hegazi</p>
          ...
          <div className="rounded-full bg-gray-300 min-w-[0.75em] max-w-[0.75em] min-h-[0.75em] max-h-[0.75em]"></div>
          <div className="">
            <p className="text-lg font-medium text-center ">Shubra El-Kheima</p>
