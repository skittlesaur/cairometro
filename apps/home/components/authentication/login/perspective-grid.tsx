...
const PerspectiveGrid = () => {
  return (
    ...
    >
      ...
      <Location
        className="absolute fill-primary w-10 top-[34.7%] right-[34.1%] "
      />

      <div className="bg-green-400 absolute left-[47.4%] bottom-0 z-[1]">
        <Radial character="M" />
      </div>
      ...
      >
        ...
        <div id="Glowing lines">
          <div className="absolute border-primary h-[21%] border-2 border-solid left-[49.89%] bottom-[12%] z-[-3]" />
